...
/** PiccrossNetworkModalVC creates a basic UI to get user input for a network connection.
...
public class PiccrossNetworkModalVC extends JDialog
{
    ...
    **/
    public PiccrossNetworkModalVC  (JFrame mainView)
    {
        ...
        //parts of the UI.  This is how you set a shortcut key for something like a text area.

        //You set the mnemonic on the label itself, and you "setLabelFor" the textarea
        //(or other item) you wish to access by keystroke.  Now, alt+A will access my "address"
        //textfield!
        ...
        outerPanel.setBorder(BorderFactory.createMatteBorder(2,2,2,2,Color.BLUE));
        
        outerPanel.add(innerPanel);
        networkPanel.add(outerPanel);
        setBounds(0, 0, 300, 300);
        setLocationRelativeTo(mainView);
        //When assembling a UI with any layout manager, the last statement should be "pack".
        pack();
    }
    ...
    */
    ...
    /** Getter method to return the value of the port the user selected in the JComboBox.
    @return This integer will be between 10,000 and 65535. Negative values indicate input error.
    */
    public int getPort()
    {
        //If this method returns negative values, the user can not hit "connect" to continue.
        //You don't strictly have to test for it yourself but being safe isn't a bad policy.
        int portnum=-1;
        if (hasConnected)
        {
            try
    ...
    private void hideModal()
    {
        ...
        //As a suggestion, you may want to reset error messages here so the UI starts up clean
        //the next time the user tries to enter input.
        //I've intentionally not done this, because I want you to. It's worth points to you.
        
        setVisible(false);
        
    }
    
    /** Used to test the modal to see how the user exited: Did they press connect or cancel?
    @return hasConnected True if "connect" was pressed and the user wants to try connecting.
    */
    ...
    */
    private class Controller implements ActionListener
    {
        ...
        {
            //Flag remains true if all data input tests are passed, permits leaving the modal.
            boolean flag=true;
